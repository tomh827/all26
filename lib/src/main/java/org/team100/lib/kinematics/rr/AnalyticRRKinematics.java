 ...
 */
public class AnalyticRRKinematics implements RRKinematics {
     ...
     */
    public AnalyticRRKinematics(double l1, double l2) {
        this.l1 = l1;
        this.l2 = l2;
    }
    ...
    @Override
    public RRPosition forward(RRConfig a) {
     ...
     */
    @Override
    public RRConfig inverse(Translation2d t) {
        double r = t.getNorm();
