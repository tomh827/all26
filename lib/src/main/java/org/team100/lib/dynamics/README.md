...
There is dynamics support for many mechanisms:

* [Revolute (R)](r/README.md) -- a very simple single-jointed arm.
* [Prismatic-Revolute (PR)](pr/README.md) -- an elevator an simple arm.
* [Revolute-Revolute (RR)](rr/README.md) -- a two-jointed arm.
* [Prismatic-Revolute-Revolute (PRR)](prr/README.md) -- 2025 Calgames mech.
* [Planar rigid body (SE2)](se2/README.md) -- using intrinsic coordinates: swerve.
