...
public class CenterFullSweepAuton implements AnnotatedCommand {
    ...
    public String name() {
      ...
      TrajectorySE2 t1(Pose2d startingPose) {
        List<WaypointSE2> waypoints = List.of(
                ...
                new WaypointSE2(new Pose2d(4, 5.5, new Rotation2d(90 * (Math.PI / 180))),
