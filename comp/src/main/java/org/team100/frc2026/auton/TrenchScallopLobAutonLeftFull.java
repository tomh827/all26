...
public class TrenchScallopLobAutonLeftFull implements AnnotatedCommand {
    private final LoggerFactory log;
    private final ControllerSE2 controller;
    private final Machinery machinery;
    private final TrajectorySE2Planner planner;

    public TrenchScallopLobAutonLeftFull(
    ...
    @Override
    public String name() {
        return "TrenchScallopLobLeftFull";
    }
    ...
    TrajectorySE2 t1(Pose2d startingPose) {
        List<WaypointSE2> waypoints = List.of(
                ...
                new WaypointSE2(new Pose2d(6, 7.5, new Rotation2d(165 * (Math.PI / 180))), new DirectionSE2(1, 0, 0),
                        1),

                new WaypointSE2(new Pose2d(9, 6, new Rotation2d(165 * (Math.PI / 180))), new DirectionSE2(1, 0, 0), 1),
                new WaypointSE2(new Pose2d(7, 5.9, new Rotation2d(165 * (Math.PI / 180))), new DirectionSE2(1, 0, 0),
                        1),

                new WaypointSE2(new Pose2d(9, 5.4, new Rotation2d(155 * (Math.PI / 180))), new DirectionSE2(-1, 0, 0),
                        1),

                new WaypointSE2(new Pose2d(7, 5.3, new Rotation2d(155 * (Math.PI / 180))), new DirectionSE2(1, 0, 0),
                        1),
                new WaypointSE2(new Pose2d(9, 5, new Rotation2d(155 * (Math.PI / 180))), new DirectionSE2(1, 0, 0), 1),

                new WaypointSE2(new Pose2d(7, 4.7, new Rotation2d(150 * (Math.PI / 180))), new DirectionSE2(-1, 0, 0),
                        1),

                new WaypointSE2(new Pose2d(9, 4.6, new Rotation2d(150 * (Math.PI / 180))), new DirectionSE2(1, 0, 0),
                        1),
                new WaypointSE2(new Pose2d(7, 4.5, new Rotation2d(150 * (Math.PI / 180))), new DirectionSE2(1, 0, 0),
                        1),

                new WaypointSE2(new Pose2d(9, 3.3, new Rotation2d(210 * (Math.PI / 180))), new DirectionSE2(1, 0.5, 0),
                        1),

                new WaypointSE2(new Pose2d(7, 2.1, new Rotation2d(205 * (Math.PI / 180))), new DirectionSE2(1, 0.5, 0),
                        1),
                new WaypointSE2(new Pose2d(9, 2.6, new Rotation2d(205 * (Math.PI / 180))), new DirectionSE2(1, 0, 0),
                        1),

                new WaypointSE2(new Pose2d(7, 1.2, new Rotation2d(205 * (Math.PI / 180))), new DirectionSE2(1, 0.5, 0),
                        1),

                new WaypointSE2(new Pose2d(9, 1.8, new Rotation2d(195 * (Math.PI / 180))), new DirectionSE2(1, 0.5, 0),
                        1)
